...
preferences {
    ...
    input("ReportTime", "number", title: "Report Timeout Interval?", description: "The time in minutes after which an update is sent?", defaultValue: 1, required: false)
...
def parse(String description)
{
	...
	if( get_battery == true ) 
	{
		...
		def age = last ? (new Date().time - last.date.time)/1000 : 10
