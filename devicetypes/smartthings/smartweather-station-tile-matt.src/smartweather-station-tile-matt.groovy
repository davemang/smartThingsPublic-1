...
metadata {
	...
	definition (name: "SmartWeather Station Tile-Matt", namespace: "smartthings", author: "SmartThings") {
...
// handle commands
def poll() {
	log.debug "WUSTATION: Executing 'poll', location: ${location.name}, isa: $app.id"
