/**
 *  SmartSense Temp/Humidity Sensor Custom
 *
 ...
 */
metadata {
	definition (name: "SmartSense Temp/Humidity Sensor Custom",namespace: "smartthings", author: "SmartThings+BAB") {
...
def getTemperature(value) {
	Float celsius = (Integer.parseInt(value, 16).shortValue()) / 100f
...
def poll() 
{
	...
	[
		...
		"zcl global read 0xFC45 0", "delay 60",						/* Humidity */
...
def refresh()
{
	...
	[
		...
		"zcl mfg-code 0xC2DF", "delay 1000",
		"zcl global read 0xFC45 0", "delay 60",
		"send 0x${device.deviceNetworkId} 1 1", "delay 1000",
...
def configure() {
	...
	def configCmds = [	
        ...
        "zcl global send-me-a-report 1 0x20 0x20 60 60 {0100}", "delay 60",
        "send 0x${device.deviceNetworkId} 1 1", "delay 500",
        
        "zcl global send-me-a-report 0x402 0 0x29 60 60 {6400}", "delay 60",
        "send 0x${device.deviceNetworkId} 1 1", "delay 500",
        
        "zcl global send-me-a-report 0xFC45 0 0x29 60 60 {6400}", "delay 60",
        "send 0x${device.deviceNetworkId} 1 1", "delay 500",
        
        "zdo bind 0x${device.deviceNetworkId} 1 1 0xFC45 {${device.zigbeeId}} {}", "delay 60",
		"zdo bind 0x${device.deviceNetworkId} 1 1 0x402 {${device.zigbeeId}} {}", "delay 60",
